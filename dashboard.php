    ...
    <nav class="bg-white w-[15%] h-screen pt-[2%] pb-[1%] border-r border-r-[#c0c0c0] flex flex-col justify-between overflow-hidden fixed">
        <div class="flex flex-col gap-10">
            <header class="flex flex-row gap-9 items-center border-b border-b-[#c0c0c0] p-[7%]">
                <div class="flex flex-row gap-2.5 navBar_logo">
                ...
                <div>
                    <button class="cursor-pointer block minimize_navBar--button" id="minimize_navBar--button">
                    ...
                    <button class="hidden cursor-pointer enlargement_navBar--button">
        ...
        <div class="grid grid-cols-2 gap-5">
            ...
            <div class="w-full h-[350px] bg-white border border-[#c0c0c0] rounded-4xl shadow-xl p-[4%] flex flex-col gap-5">
                ...
                <div class="w-full h-[250px] relative">
                    <canvas id="repartition_des_Comptes"></canvas>
                </div>
            </div>
        </div>
