    ...
    <nav class="bg-white w-[15%] h-screen pt-[2%] pb-[1%] border-r border-r-[#c0c0c0] flex flex-col justify-between overflow-hidden fixed" id="dashboard_nav_bar">
        <div class="flex flex-col gap-10">
            ...
            <div class="flex flex-col gap-5 items-center h-full">
                ...
                <a href="transactions.php" class="group flex flex-row items-center justify-between gap-2.5 cursor-pointer py-2 w-[85%] pl-2 pr-2 rounded-2xl bg-[rgba(0,102,255,0.7)] hover:bg-[rgba(0,102,255,1)] text-white">
                    <button class="cursor-pointer flex gap-2.5" id="transactions_section--button--nav">
                        <svg class="stroke-[#ffffff]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke-width="2" d="M2 7h18m-4-5l5 5l-5 5m6 5H4m4-5l-5 5l5 5"/></svg>
