    ...
    <div class="flex flex-col gap-10">
        ...
        <div class="flex flex-col gap-5 items-center h-full">
            <a href="dashboard.php">
                <button class="group flex flex-row items-center justify-between gap-2.5 cursor-pointer py-2 w-[85%] pl-2 pr-2 rounded-2xl bg-[rgba(0,102,255,0.7)] hover:bg-[rgba(0,102,255,1)] text-white" id="dashboard_section--button--nav">
