                ...
                <div class="w-full flex flex-col gap-10">
                    ...
                    <div class="flex items-center w-full gap-[2%]">
                        <div class="w-full flex flex-col gap-2.5">
                            ...
                            <div class="w-full border-2 border-[#c0c0c0] rounded-2xl p-[2%] flex items-center">
                                ...
                                <input type="text" class="w-full pl-[2%] outline-0" placeholder="Entre le nom complete du client..." required name="upload_client--fullName--input" id="upload_client--fullName--input" max="32">
                            </div>
                        </div>
                        <div class="w-full flex flex-col gap-2.5">
                            ...
                            <div class="w-full border-2 border-[#c0c0c0] rounded-2xl p-[2%] flex items-center">
                                ...
                                <input type="text" class="w-full pl-[2%] outline-0" placeholder="Entre le numéro de CIN(Cart d'identite national) du client..." required name="upload_client--CIN--input" id="upload_client--CIN--input" max="10">
                            </div>
                        </div>
                    </div>
                    <div class="flex items-center w-full gap-[2%]">
                        <div class="w-full flex flex-col gap-2.5">
                            ...
                            <div class="w-full border-2 border-[#c0c0c0] rounded-2xl p-[2%] flex items-center">
                                ...
                                <input type="email" class="w-full pl-[2%] outline-0" placeholder="email@example.com" required name="upload_client--Email--input" id="upload_client--Email--input" max="50">
                            </div>
                        </div>
                        <div class="w-full flex flex-col gap-2.5">
                            ...
                            <div class="w-full border-2 border-[#c0c0c0] rounded-2xl p-[2%] flex items-center">
                                ...
                                <input type="tel" class="w-full pl-[2%] outline-0" placeholder="+2126XXXXXXXX" required name="upload_client--phoneNumber--input" id="upload_client--phoneNumber--input" max="10">
                            </div>
                        </div>
                    </div>
                    <div class="flex items-center w-full gap-[2%]">
                    ...
                    <div>
                        ...
                        <div class="w-full border-2 border-[#c0c0c0] rounded-2xl p-[1%] flex items-center">
                            ...
                            <input type="text" class="w-full pl-[1%] outline-0" placeholder="Entre l'adresse complete du client..." required name="upload_client--Adresse--input" id="upload_client--Adresse--input" max="100">
                        </div>
                    </div>
